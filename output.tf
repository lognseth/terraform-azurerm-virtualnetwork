...
output "asg_ssh_access" {
  value = azurerm_application_security_group.ssh_access
}
...
output "asg_mysql_server" {
  value = azurerm_application_security_group.mysql_server
}
...
output "asg_rdp_access" {
  value = azurerm_application_security_group.rdp_access
}
